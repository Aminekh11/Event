...
<head>
    ...
    <style>
        body {
            ...
            color: #9b1c31; /* Match the background color for text */
...
// Display all fields for each event
foreach ($events as $event) {
    ...
    foreach ($events as $event) {
        ...
        // Add a form for rating and commenting
        ...
        echo "</form>";
        echo "<hr>"; // Add a horizontal line between events for better separation
    }

    // Check user role (you should implement authentication and have a way to determine the user role)
    $userRole = "client"; // Replace with the actual logic to determine the user role

    if ($userRole === "admin") {
        // For admins, show an update link
